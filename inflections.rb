...
ActiveSupport::Inflector.inflections(:es) do |inflect|
  ...
  # Se adiciona la regla para finalización en k, como cracks, clicks
  #
  ...
  # clicks and cracks
  inflect.plural(/^(.+)k/,'\1ks')
  inflect.singular(/^(.+)ks/,'\1k')
  # ciones
  inflect.plural(/^(.+)ión/, '\1iones')
  inflect.singular(/^(.+)iones/, '\1ión')
  #
  #
  ############# Fin casos generales
